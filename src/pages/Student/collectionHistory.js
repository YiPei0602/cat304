                  ...
                  <tr key={item.id}>
                    ...
                    <td className="px-4 py-2">
                      {item.status === 'Ready to collect' && (
                        <Popup trigger={<button className="text-blue-500 underline focus:outline-none">Show QR</button>} modal>
                          ...
                          <div className="flex flex-col items-center">
                                <h2 className="text-xl font-bold mb-4">Collection QR Code</h2>
                                <QRCodeSVG 
                                  id="qrCode" // Add an ID to target the QR code for downloading
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    const svgElement = document.getElementById('qrCode'); // Select the QR code SVG
                                    ...
                                    link.href = url;
                                    link.download = `${item.itemName}-QRCode.svg`;
