...
//   const location = useLocation();
//   const navigate = useNavigate();
//   const { role } = location.state || { role: 'student' }; // Default role is 'student'

//   const incomeThreshold = 5249; // Household income threshold for eligibility
...
//       hasUpCase: uppercaseCheck,
//       hasLowCase: lowercaseCheck,
//       hasNum: numberCheck,
//     });
//   };

//   const checkStudentEligibility = async (matricNo) => {
//     try {
//       const firestore = getFirestore(app);
//       const studentsRef = collection(firestore, 'students');
//       const q = query(studentsRef, where('matricNo', '==', matricNo));
//       const querySnapshot = await getDocs(q);
...
//     if (role === 'student') {
//       try {
//         const eligibilityCheck = await checkStudentEligibility(matric);
//         if (!eligibilityCheck.isEligible) {
//           alert(eligibilityCheck.error);
//           return;
//         }
